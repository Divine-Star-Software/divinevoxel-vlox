...
export interface OctahedronVoxelTemplateData
  extends IVoxelShapeTemplateData<"octahedron-shape"> {
  width: number;
  height: number;
  depth: number;
}
...
export class OctahedronVoxelTemplate extends BasicVoxelShapeTemplate<
  "octahedron-shape",
  OctahedronVoxelTemplateData
> {
  static CreateNew(
    data: Partial<OctahedronVoxelTemplateData>
  ): OctahedronVoxelTemplateData {
    return {
