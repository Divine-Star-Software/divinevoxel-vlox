...
export interface ConeVoxelShapeSelectionData
  extends IVoxelShapeSelectionData<"cone-shape"> {
  width: number;
  height: number;
  depth: number;
}
...
export class ConeVoxelShapeSelection
  implements IVoxelShapeSelection<"cone-shape", ConeVoxelShapeSelectionData>
{
  static readonly Type = "cone-shape";
  static CreateNew(
    data: Partial<ConeVoxelShapeSelectionData>
  ): ConeVoxelShapeSelectionData {
    return {
