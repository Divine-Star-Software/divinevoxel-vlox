...
export interface BoxVoxelShapeSelectionData
  extends IVoxelShapeSelectionData<"box-shape"> {
  width: number;
  height: number;
  depth: number;
}
...
export class BoxVoxelShapeSelection
  implements IVoxelShapeSelection<"box-shape", BoxVoxelShapeSelectionData>
{
  static readonly Type = "box-shape";
  static CreateNew(
    data: Partial<BoxVoxelShapeSelectionData>
  ): BoxVoxelShapeSelectionData {
    return {
